...
def open_hard_quiz():
    ...
    def check_answer():
        ...
        hard_win.after(1500, next_question)
        

    # Label to display the current math question
    question_label = tk.Label(hard_win, text="", font=("Adamina", 16), wraplength=550)
    question_label.pack(pady=20)
    # Entry box for the user to type their answer
    answer_entry = tk.Entry(hard_win, font=("Nico Moji", 18))
    answer_entry.pack(pady=10)
   # Button to submit the answer and trigger the check_answer function
    submit_btn = tk.Button(hard_win, text="SUBMIT", font=("Nico Moji", 16), command=check_answer)
    submit_btn.pack(pady=10)
   # Label to show the result after submitting (e.g., Correct or Wrong)
    result_label = tk.Label(hard_win, text="", font=("Nico Mmoji", 16))
...
def show_score_window():
    ...
    # Buttons for score window
    e_restart_btn = tk.Button(score_win, text="RESTART", font=("Nico Moji", 18), bg="black", fg="white", command=easy_restart_quiz)
    e_restart_btn.place(relx=0.28, rely=0.60, relwidth=0.13, relheight=0.09)

    m_restart_btn = tk.Button(score_win, text="RESTART", font=("Nico Moji", 18), bg="black", fg="white", command=medium_restart_quiz)
    m_restart_btn.place(relx=0.28, rely=0.60, relwidth=0.13, relheight=0.09)

    h_restart_btn = tk.Button(score_win, text="RESTART", font=("Nico Moji", 18), bg="black", fg="white", command=hard_restart_quiz)
    h_restart_btn.place(relx=0.28, rely=0.60, relwidth=0.13, relheight=0.09)
...
def open_difficulty_window():
    ...
    #Hard Buton
    hard_btn = tk.Button(diff_win, text="HARD", font=("Nico Moji", 18), fg="white", bg="black", command=open_hard_quiz)
